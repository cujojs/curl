...
"use strict";
	 ...
	 *
	 * @param setup {isolatedFunction|Undefined} if defined, this
	 *   function will be run immediately before the returned function.
	 * @param teardown {isolatedFunction|Undefined} if defined, this
	 ...
	 * 		var cjsPromise = when(r1.run(function () {
	 * 			// do tests here
	 * 		});
	 * 	});
	 *
	 */
	return function runner (setup, teardown, require) {
		var promise;
